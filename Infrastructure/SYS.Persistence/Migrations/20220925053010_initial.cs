    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Depties", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Owners_Depties_DeptId",
                        column: x => x.DeptId,
                        principalTable: "Depties",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Owners_Dues_DuesId",
                        column: x => x.DuesId,
                        principalTable: "Dues",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Owners_DeptId",
                table: "Owners",
                column: "DeptId");

            migrationBuilder.CreateIndex(
                name: "IX_Owners_DuesId",
                table: "Owners",
                column: "DuesId");
